...
colunas_para_remover = [
    ...
    "Unnamed: 21", "Unnamed: 22", "Unnamed: 23", "TRAÇÃO.1", "VERSÕES",
...
def index():
    ...
    for col in columns_filtros:
        if col == "MODELO" and marca_selecionada:
    ...
    for _, row in paged_df.iterrows():
        ...
        result_row["PDF Link"] = f"/static/pdfs/{pdf_filename}" if os.path.exists(pdf_path) else None
